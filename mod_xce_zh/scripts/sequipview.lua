...
local pastHeight = 0.045; -- originally 0.035
local statHeight = 0.05; -- originally 0.045
local navigationText = 0.06; -- originally 0.045
local categoryText = 0.02; -- originally 0.014
local soldierListText = 0.017; -- originally 0.014
local slotLabelHeight = 1.5; -- originally 1.0
local statProgressLeft = 0.16; -- originally 0.3
local statProgressWidth = 0.7; -- originally 0.6
...
MakeDialog
{
  SoldierEquipView
  {
    ...
    ScalingText
    {
      ...
      name = "hideme1",
      x = 280 * screenScaleX,
      y = 135 * screenScaleY + ( 23 * screenScaleY + ( 160 * 2 / 5 ) * screenScaleX ) * 2 + 5 + 15,
      w = 160 * screenScaleX,
      h = 22 * screenScaleY,
      flags = kHAlignLeft + kVAlignBottom,
    ...
    ScalingText
    {
      ...
      name = "hideme2",
      x = 280 * screenScaleX,
      y = 133 * screenScaleY + ( 23 * screenScaleY + ( 160 * 2 / 5 ) * screenScaleX ) * 2 + 5 + 15 + 12 * screenScaleY + 12 * screenScaleY + 5,
      w = 160 * screenScaleX,
      h = 22 * screenScaleY,
      flags = kHAlignLeft + kVAlignBottom,
    ...
    TiledImage
    {
      ...
      DottedLabel
      {
        ...
        ProgressBar
        {
          font = XenonautsDisabledFont,
          name = "progress",
          x = stw * 0.95 * statProgressLeft,
          y = screenResolutionH * 0.004,
          w = stw * 0.95 * statProgressWidth,
          h = kMax - 2,
    ...
    TiledImage
    {
      ...
      ListControl
      {
        ...
        fontScale = screenResolutionH * soldierListText,
        thcolor = RedColor,
        hswl = true,
    ...
    TiledImage
    {
      ...
      TiledButton
      {
        ...
        font = CatButtonFont,
        label = "SEQ.WEAPONS",
        fontScale = screenResolutionH * categoryText,
    ...
    ScalingText
    {
      ...
      name = "roleboxlabel",
      x = 580 * screenScaleX,
      y = 55 * screenScaleY, -- 1.49 * Floor( 30 * screenScaleX ),
      w = 70 * screenScaleY,
      h = 55 * screenScaleY,
      label = "SEQ.ROLEBOX",
      fontScale = screenScaleY * slotLabelHeight,
