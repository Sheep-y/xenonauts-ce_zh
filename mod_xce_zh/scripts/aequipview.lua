...
local progressBarLeft  = stw * 0.18; -- originally stw * 0.325
local progressBarWidth = stw * 0.18; -- originally stw * 0.18
  ...
  AirplaneEquipView
  {
    ...
    TiledImage
    {
      ...
      ProgressBar
      {
        ...
        name = "fuellevelp",
        x = progressBarLeft,
        y = stw * 0.208 + Floor( stw * 0.042) * 6 + Floor( stw * 0.06 ) * 0 + stw * 0.005,
      ...
      ProgressBar
      {
        ...
        name = "ammolevelp",
        x = progressBarLeft,
        y = stw * 0.208 + Floor( stw * 0.042) * 6 + Floor( stw * 0.06 ) * 1 + stw * 0.005,
        w = kMax - progressBarWidth,
        h = stw * 0.03,
        barheight = stw * 0.0275,
        min = 1,
      ...
      ProgressBar
      {
        ...
        name = "healthp",
        x = progressBarLeft,
        y = stw * 0.208 + Floor( stw * 0.042) * 6 + Floor( stw * 0.06 ) * 2 + stw * 0.005,
        w = kMax - progressBarWidth,
        h = stw * 0.03,
        barheight = stw * 0.0275,
        min = 1,
