    ...
    NonUniformScaledImage
    {
      ...
      TiledImage
      {
        ...
        ScalingText
        {
          ...
          w = sbw * 0.45 - sbw * 0.01,
          h = kMax,
          fontScale = tableHeaderFontHeight * 0.8,
